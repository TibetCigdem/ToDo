    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Can't you remember your tasks?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            To-Do Application is here for you!
          </h1>
          <p class="leading-normal text-2xl mb-8">
            You can create your To-Do tasks. With this application you won't forget anything. Register now and feel changes in your life! 
          </p>
          @if (Route::has('register'))
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="{{URL('images/appicon.png')}}" />
        </div>
      </div>
    </div>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              Users can create their tasks and they can change those tasks whenever they want, when they completed their tasks, they can change task status or delete.
              <br />
              <br />
            </p>
          </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                You can access this application from anywhere in the world. All you need is internet connection.
                <br />
                <br />
              </p>
            </div>
